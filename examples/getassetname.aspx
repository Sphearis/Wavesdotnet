...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script runat="server">
		...
		Sub Getassetname(ByVal sender As Object, ByVal e As EventArgs)
...
<body>
    ...
    <div>
    Get Asset Name:<br />AssetID <asp:textbox id=assetidinput width=350 runat=server /><asp:button text="Get Name" id=validatebtn onclick=getassetname runat=server /> <asp:Label ID="assetname" runat="server"></asp:Label><br />
